...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing:
            ...
            #self.epsilon = self.epsilon - 0.05 # gave ratings : F, F
            #self.epsilon = (self.a)**self.t # gave ratings : F, F
            #self.epsilon =1.0/(self.t**2) # gave ratings : D, F
            self.epsilon = math.exp(-(self.a*self.t)) # gave ratings : A+, A+
            #self.epsilon = math.cos(self.a*self.trial_num) # gave ratings : A+, F
